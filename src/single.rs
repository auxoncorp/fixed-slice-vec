...
mod tests {
    ...
    fn zero_sized_types_not_permitted() {
        ...
        let mut uninit_bytes = [MaybeUninit::<u8>::uninit(); 64];
    ...
    fn happy_path_split_uninit() {
        let mut uninit_bytes = [MaybeUninit::<u8>::uninit(); 512];
    ...
    fn happy_path_embed_uninit() {
        const BACKING_BYTES_MAX_SIZE: usize = 512;
        let mut uninit_bytes = [MaybeUninit::<u8>::uninit(); BACKING_BYTES_MAX_SIZE];
